    ...
    <div className="bg-red-50 py-10 px-10 flex flex-col max-sm:px-2 mt-16">
      <div className="flex flex-wrap py-8 gap-16 items-start justify-center">
        ...
        <div className="space-y-3">
          ...
          <p className="text-base-bold">+234 703 292 0367</p>
          <p className="text-base-bold">hello@mrtee.com</p>
        </div>
        <div className="space-y-3">
          <p className="text-heading3-bold">Never Miss a Deal</p>
          ...
          <p className="text-xs">Join our subscribers and get best deals delivered each week!</p>
        </div>
      </div>
